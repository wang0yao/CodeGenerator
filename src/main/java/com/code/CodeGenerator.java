...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\java"); //生成文件的输出目录
        gc.setAuthor("wyy"); //作者
        ...
        dsc.setUrl(
            "jdbc:mysql://192.168.2.231:3356/pfts?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("pftsuser");
        dsc.setPassword("YooNuu@qwe@123");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        //            pc.setModuleName(scanner("模块名"));
        pc.setParent("com.gapf");
        ...
        //        strategy.setSuperEntityClass("com.gesp.common.domain.BaseEntity");
        strategy.setSuperEntityColumns("create_by", "create_time", "update_by",
            "update_time", "remark", "deleted"); //自定义实体，公共字段
        ...
        strategy.setInclude(new String[] { "ga_region" }); // 需要生成的表可以多张表
