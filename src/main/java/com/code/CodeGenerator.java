...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\xri-microservice\\xri-microsservice-module\\xri-microsservice-service-provider-impl\\src\\main\\java");    //生成文件的输出目录
...
//        gc.setEntityName("%sEntity");            //实体命名方式  默认值：null 例如：%sEntity 生成 UserEntity
        ...
        dsc.setUrl("jdbc:mysql://101.200.216.126:3306/goods?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//	        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.frame.provider");
